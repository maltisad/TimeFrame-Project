    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{url('/admin/posts/create')}}">New</a>
          <a class="dropdown-item" href="{{url('/admin/posts')}}">List</a>
          <div class="dropdown-divider"></div>
          <h6 class="dropdown-header">Users:</h6>
          <a class="dropdown-item" href="blank.html">New</a>
                    <a class="dropdown-item" href="404.html">List</a>
        </div>
      </li>
      <li class="nav-item">
